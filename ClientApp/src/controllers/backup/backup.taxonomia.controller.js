...
const behaviors = (parent, yesHref) => {
    parent.querySelector('#continue').addEventListener('click', () => {
        ...
        dataIssue[Vault.groups.backup.key][Vault.fields.layerTemporary.key] = parent.querySelector(`#${Vault.fields.layerTemporary.key}`).value.toLowerCase();
        dataIssue[Vault.groups.backup.key][Vault.fields.unitTemporary.key] = parent.querySelector(`#${Vault.fields.unitTemporary.key}`).value.toLowerCase();
        dataIssue[Vault.groups.backup.key][Vault.fields.solutionTemporary.key] = parent.querySelector(`#${Vault.fields.solutionTemporary.key}`).value.toLowerCase();
        dataIssue[Vault.groups.backup.key][Vault.fields.pathTemporary.key] = parent.querySelector(`#${Vault.fields.pathTemporary.key}`).value.toLowerCase();
        dataIssue[Vault.groups.backup.key][Vault.fields.layerScript.key] = parent.querySelector(`#${Vault.fields.layerScript.key}`).value.toLowerCase();
        dataIssue[Vault.groups.backup.key][Vault.fields.unitScript.key] = parent.querySelector(`#${Vault.fields.unitScript.key}`).value.toLowerCase();
        dataIssue[Vault.groups.backup.key][Vault.fields.solutionScript.key] = parent.querySelector(`#${Vault.fields.solutionScript.key}`).value.toLowerCase();
        dataIssue[Vault.groups.backup.key][Vault.fields.pathScript.key] = parent.querySelector(`#${Vault.fields.pathScript.key}`).value.toLowerCase();
